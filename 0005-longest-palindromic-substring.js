...
function manacher(originStr) {
    // 0. generate a new str to avoid boundary situations
    // 'abcb' => '*#a#b#c#b#'
    var extStr = '*#'
    ...
    var result = ifSharpCenter ? '' : extStr[pos]
    var startPos = ifSharpCenter ? pos + 1 : pos + 2
    var endPos = ifSharpCenter ? dp[pos] - 3 + startPos
                               : dp[pos] - 4 + startPos
